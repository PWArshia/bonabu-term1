...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (n!=8){
            ...
            if (n==1){
                ...
                String poly1=in.next();
                poly1=corrector(poly1);
                System.out.print("enter polynomial 2:");
                String poly2=in.next();
                poly2=corrector(poly2);
                System.out.println("answer="+Psum(poly2+poly1));
                menue();
                n=in.nextInt();
            }
            ...
            if(n==2){
                ...
                String poly2=in.next();
                poly2=corrector(poly2);
                System.out.println("answer="+Pminus(poly1,poly2));
                menue();
                n=in.nextInt();
            }
            ...
            if(n==3){
                ...
                String poly2=in.next();
                poly2=corrector(poly2);
                System.out.println("answer="+Pmultiple(poly1,poly2));
                menue();
                n=in.nextInt();
            }
            ...
            if(n==4){
                ...
                String poly2=in.next();
                poly2=corrector(poly2);
                System.out.println("answer="+Pdive(poly1,poly2));
                menue();
                n=in.nextInt();
            }
            ...
            if (n==5){
                ...
                String poly1=in.next();
                poly1=corrector(poly1);
                System.out.println("answer="+PDerivate(poly1));
                menue();
                n=in.nextInt();
            }
            ...
            if (n==6){
                ...
                String poly1=in.next();
                poly1=corrector(poly1);
                System.out.println("answer="+PIntegral(poly1));
                menue();
                n=in.nextInt();
            }

            if (n==7){
                System.out.print("enter polynomial1:");
                String poly1=in.next();
                poly1=corrector(poly1);
                System.out.print("enter polynomial2:");
                String poly2=in.next();
                poly2=corrector(poly2);
                System.out.println("answer="+PMode(poly1,poly2));
                menue();
                n=in.nextInt();
            }
        }
    ...
    public static void menue(){
        ...
        System.out.println("whats you want to do?");
        System.out.println("1.sum");
        System.out.println("2.minus");
        System.out.println("3.multiply");
        System.out.println("4.divide");
        System.out.println("5.Derivate");
